...
app.use(serve_favicon_1.default(path_1.default.join(__dirname, 'assets/favicons', 'favicon.ico')));
app.use(express_1.default.static('built/assets'));
...
app.get(['/', '/error', '/deploying/:format/:deployId', '/userinfo', '/testform', '/deleteConfirm'], (req, res, next) => {
    res.sendFile('index.html', { root: path_1.default.join(__dirname, '../built/assets') });
});
...
const commonDeploy = async (req, url) => {
    ...
    utilities_1.default.runHerokuBuilder();
