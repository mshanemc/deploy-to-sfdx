...
const pooledOrgFinder = async function (deployReq, forcePool = false) {
    try {
        ...
        cds = Object.assign({}, cds, { buildStartTime: new Date(), deployId: deployReq.deployId, browserStartTime: deployReq.createdTimestamp || new Date(), complete: false, isPool: false });
