  ...
  router.post('/deploying', (req, res) => {
    ...
    switch (command) {
      ...
      case 'password':
        ...
        script = `${startingDirectory}cd ${directory};export FORCE_SHOW_SPINNER=;sfdx force:config:set instanceUrl=${instance_url};sfdx force:user:password:generate -v ${access_token}`;
          commands.run(command, script, (commandResult, commandErr) => {
