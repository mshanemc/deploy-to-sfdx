    ...
    switch (command) {
      ...
      case 'permset':
        ...
        case 'password':
          ...
          script = `${startingDirectory}cd ${directory};sfdx force:config:set instanceUrl=${instance_url};export FORCE_SHOW_SPINNER=;sfdx force:user:password:generate -v '${access_token}'`;
