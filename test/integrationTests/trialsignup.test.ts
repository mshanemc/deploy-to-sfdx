...
describe.skip('runs the trial', () => {
    ...
    test('gets form and completes it successfully', async() => {
    ...
    test('submits form and gets to loading screen, then leaves', async() => {
        await page.waitForSelector('input#submitButton', { timeout: shouldBeLoaded});
    ...
    test('eventually gets to actual trial', async() => {
